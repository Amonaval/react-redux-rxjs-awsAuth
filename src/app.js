                    ...
                    <Router>
                        ...
                        <Navbar auth={authProps} themeChange={this.themeChange} themetype={this.state.darkTheme} />
                            <Switch>
                                ...
                                <Route exact path="/app/donar" render={(props) => <SubComponent {...props} auth={authProps} flow={'donar'} />} />
                                <Route exact path="/app/helpinghand" render={(props) => <SubComponent {...props} auth={authProps} flow={'helpinghand'} />} />
